def detect_significant_change_jenis_penyakit(df, group_col="jenis_penderita",
                                     value_col="jumlah_penderita",
                                     time_col="tahun",
                                     pct_threshold=50, abs_threshold=5):
    """
    Deteksi kenaikan/penurunan signifikan jumlah penderita per jenis penderita di satu kab/kota.
    """
    alerts = []
